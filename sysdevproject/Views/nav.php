    ...
    <header>
        <nav>
            ...
            <ul>
                ...
                <li class="hideOnMobile"><a href="<?php echo $path ."/". $language . "/Location"; ?>" class="menu-items"><?=LOCATIONS?></a></li>
                <li class="hideOnMobile"><a href="<?php echo $path ."/". $language . "/Contact"; ?>" class="menu-items"><?=CONTACTUS?></a></li>
                <li class="hideOnMobile"><a href="<?php echo $path ."/". $language . "/Reservation"; ?>" class="menu-items"><?=RESERVE?></a></li>
